...
<div class="container">
    ...
    <div class="form-group">
	    ...
	    <div class="input-group">
			<input type="number" maxlength="11" id="mobile" class="form-control">
	...
	<div class="form-group" style=" text-align: center; ">
		<button type="button" id="registeredBtn" class="btn btn-success btn-lg btn-block"> 注 册 </button>
	</div>
